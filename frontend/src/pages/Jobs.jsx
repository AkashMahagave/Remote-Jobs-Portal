      ...
      <div className="container mx-auto px-4">
        ...
        <div className="bg-white rounded-3xl p-8 mb-10 shadow-sm border border-gray-100">
          <div className="text-center mb-6">
            <h3 className="text-lg font-black text-gray-900">Top Companies Hiring</h3>
            <p className="text-sm text-gray-500 font-medium">Find remote opportunities from these industry leaders</p>
          </div>
