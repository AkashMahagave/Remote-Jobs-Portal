...
export const AuthProvider = ({ children }) => {
  ...
  // In development (Vite), we use a proxy (/api). 
  // In production (Static build), we point directly to the backend.
  const backendUrl = import.meta.env.DEV ? '/api' : 'http://127.0.0.1:5001/api';
