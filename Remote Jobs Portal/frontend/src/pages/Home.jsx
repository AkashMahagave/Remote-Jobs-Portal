      ...
      <section className="py-12 border-b border-gray-100 bg-white">
        <div className="container mx-auto px-4">
          <div className="flex flex-col items-center">
            ...
            <div className="flex flex-wrap justify-center items-center gap-10 md:gap-16 lg:gap-20 transition-all duration-700">
              {["Amazon", "Google", "Microsoft", "Tesla", "Spotify", "Swiggy", "Canva", "Salesforce"].map(name => (
